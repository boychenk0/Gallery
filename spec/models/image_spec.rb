...
describe Image do
  ...
  it {should have_db_column(:url).of_type(:string).with_options(:limit => 255, :null => false)}
  it {should have_db_column(:category_id).of_type(:integer).with_options(:null => false)}
  it {should have_db_column(:created_at).of_type(:datetime).with_options(:null => false)}
  it {should have_db_column(:likes_count).of_type(:integer).with_options(:default => 0, :null => false)}
  it {should have_db_column(:comments_count).of_type(:integer).with_options(:default => 0, :null => false)}
